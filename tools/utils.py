...
from tools.common.conventions import get_run_history_experiment_path, DATETIME_FORMAT
...
def setup_pipeline(cfg: DictConfig, task: str) -> GlobalConfig:
    ...
    config_dirpath = get_run_history_experiment_path(output_dir, cfg.train.experiment)
